#include "../../includes/layers/pooling_layer.h"
...
MatrixXd Pooling_layer::Forward_propagation(MatrixXd input_data){
 ...
 * 
 */
MatrixXd Pooling_layer::Backward_propagation(MatrixXd output_error, float learning_rate){
